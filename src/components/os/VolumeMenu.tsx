...
const VolumeMenu = ({ onClose }: VolumeMenuProps) => {
  ...
  return (
    <div 
      className="fixed bottom-[72px] left-1/2 transform -translate-x-1/2 w-72 bg-white/10 backdrop-blur-xl border border-white/20 rounded-xl p-4 os-slide-up z-40 shadow-2xl"
