...
const StartMenu = ({ onAppClick, onClose }: StartMenuProps) => {
  ...
  return (
    <div 
      className="fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-[600px] h-[700px] bg-white/10 backdrop-blur-xl border border-white/20 rounded-xl shadow-2xl os-slide-up z-40"
